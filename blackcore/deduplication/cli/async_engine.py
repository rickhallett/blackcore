...
class AsyncDeduplicationEngine:
    ...
    async def analyze_database_async(
        ...
        await self._report_progress(
            "Loading", 0, len(records), "Initializing analysis..."
        )
    ...
    def _analyze_with_progress(
        self, database_name: str, records: List[Dict[str, Any]], enable_ai: bool
    ) -> DeduplicationResult:
        """
    ...
    async def get_review_tasks_async(
        self, results: DeduplicationResult, reviewer_id: str
    ) -> List[ReviewTask]:
        """
