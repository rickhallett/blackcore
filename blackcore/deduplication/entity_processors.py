...
class BaseEntityProcessor(ABC):
    ...
    def calculate_confidence(
        ...
        entity_a: Dict[str, Any] = None,
        entity_b: Dict[str, Any] = None,
    ) -> float:
...
class PersonProcessor(BaseEntityProcessor):
    ...
    def calculate_confidence(
        ...
        supporting_matches = sum(
            1
            for field in ["Organization", "Role", "Address"]
...
class OrganizationProcessor(BaseEntityProcessor):
    ...
    def calculate_confidence(
        ...
        supporting_matches = sum(
            1
            for field in ["Website", "Email", "Phone", "Address"]
...
class DocumentProcessor(BaseEntityProcessor):
    ...
    def calculate_confidence(
        ...
        supporting_matches = sum(
            1 for score in [type_score, desc_score, source_score] if score > 70
        )
