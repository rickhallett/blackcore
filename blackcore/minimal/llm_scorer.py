...
class LLMScorer:
    ...
    def __init__(self, api_key: str, model: str = "claude-3-5-haiku-20241022", 
                 cache_ttl: int = 3600, temperature: float = 0.1):
    ...
    def score_entities(self, entity1: Dict, entity2: Dict, entity_type: str = "person",
                      context: Optional[Dict] = None) -> Tuple[float, str, Dict]:
    ...
    def score_batch(self, entity_pairs: List[Tuple[Dict, Dict, str]], 
                   batch_size: int = 5) -> List[Tuple[float, str, Dict]]:
