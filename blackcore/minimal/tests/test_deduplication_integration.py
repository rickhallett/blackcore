...
class TestDeduplicationIntegration:
    ...
    def test_full_transcript_processing_with_dedup(self, processor):
        ...
        processor.notion_updater.update_page.side_effect = [existing_person, existing_org]
        ...
        processor.notion_updater.find_or_create_page.return_value = (transcript_page, True)
