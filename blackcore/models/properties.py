...
class MultiSelectProperty(BasePropertyValue):
    ...
    def from_names(cls, names: List[str]) -> "MultiSelectProperty":
        ...
        return cls(
            multi_select=[SelectOption(name=name) for name in names]
        )
...
class DateProperty(BasePropertyValue):
    ...
    @classmethod
    def from_date(cls, start: Union[str, date, datetime], end: Optional[Union[str, date, datetime]] = None) -> "DateProperty":
