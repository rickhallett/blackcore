...
def fix_agenda_references():
    ...
    actual_agendas = {agenda["Agenda Title"] for agenda in agendas_data["Agendas & Epics"]}
    ...
    for task in tasks:
        ...
        if isinstance(related_agenda, list):
            ...
            for agenda in related_agenda:
                if agenda not in actual_agendas:
                    ...
                    if "Phase 1" in agenda:
                        fixed_list.append("Phase 1: Evidence Documentation & Intelligence Gathering")
                        fixed_count += 1
            ...
            if "Phase 1" in related_agenda:
                task["Related Agenda"] = "Phase 1: Evidence Documentation & Intelligence Gathering"
                fixed_count += 1
