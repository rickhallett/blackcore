...
def test_analysis_sync():
    ...
    test_data = [
        {"id": "1", "Full Name": "Anthony Smith", "Email": "tony@example.com", "Phone": "555-1234"},
        {"id": "2", "Full Name": "Tony Smith", "Email": "tony@example.com", "Phone": "555-1234"},
        {"id": "3", "Full Name": "Jane Doe", "Email": "jane@example.com", "Phone": "555-5678"},
    ]
