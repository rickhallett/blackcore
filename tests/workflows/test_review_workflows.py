...
class TestReviewWorkflows:
    ...
    async def test_complete_review_session(self, mock_cli_with_data):
        ...
        test_matches = [
            ...
            {
                "entity_a": {"id": "3", "Full Name": "Jane Doe", "Email": "jane@example.com"},
                "entity_b": {"id": "4", "Full Name": "Jane Doe", "Email": "j.doe@example.com"},
                "confidence_score": 80.0,
                "database": "People & Contacts", 
                "primary_entity": "B"
            },
            {
                "entity_a": {"id": "5", "Full Name": "Bob Wilson", "Email": "bob@example.com"},
                "entity_b": {"id": "6", "Full Name": "Robert Wilson", "Email": "rwilson@example.com"},
        ...
        user_decisions = [
            {"match_index": 0, "action": "a", "reasoning": "Exact match, approve"},  # Approve
            {"match_index": 1, "action": "s", "reasoning": "Swap primary"},        # Swap primary
            {"match_index": 1, "action": "a", "reasoning": "Approve after swap"},  # Approve
            {"match_index": 2, "action": "r", "reasoning": "Different people"}     # Reject
        ]
        ...
        preview_scenarios = [
            {
                ...
                "expected_conflicts": ["Organization"],  # ABC Corp vs [ABC Corp, XYZ Inc]
    ...
    async def test_review_navigation(self, mock_cli_with_data):
        ...
        for test in navigation_tests:
            ...
            assert current_index == test["expected_final_index"], \
    ...
    async def test_review_quality_validation(self, mock_cli_with_data):
        ...
        for test in quality_tests:
            ...
            assert quality == test["expected_quality"], \
    ...
    async def test_batch_decision_application(self, mock_cli_with_data):
        ...
        with patch('blackcore.deduplication.merge_proposals.MergeExecutor') as mock_executor_class:
            ...
            for decision in approved_merges:
                ...
                mock_proposal = Mock()
                mock_proposal.proposal_id = f"proposal-{primary['id']}-{secondary['id']}"
