...
class TestFullSyncScenarios:
    ...
    def test_incremental_sync_with_existing_data(self, mock_file, mock_exists, mock_client_class):
        ...
        existing_pages = [
            {"id": "page-1", "properties": {"Name": {"type": "title", "title": [{"plain_text": "Item 1"}]}}},
            {"id": "page-2", "properties": {"Name": {"type": "title", "title": [{"plain_text": "Item 2"}]}}}
        ]
    ...
    def test_data_integrity_validation(self, mock_file, mock_exists, mock_mkdir):
        ...
        assert created_payload["Tags"]["multi_select"] == [{"name": "Tag1"}, {"name": "Tag2"}, {"name": "Tag3"}]
